"""
realtime_inference_qt_alexnet.py
────────────────────────────────
...
- Main Qt app:
    ...
    + đưa ảnh vào model AlexNet để inference realtime
...
Chạy:
    python realtime_inference_qt_alexnet.py
"""
...
# CONFIG MODEL
# ══════════════════════════════════════════════
MODEL_NAME = "best_gnss_classifier_alexnet.pth"
LABEL_NAME = "label_info_alexnet.pth"
...
class SpectrogramInferenceWindow(QMainWindow):
    def __init__(self, data_queue: mp.Queue, stop_event: mp.Event, p_reader: mp.Process):
        ...
        self.setWindowTitle("bladeRF Realtime Spectrogram + AlexNet Inference")
